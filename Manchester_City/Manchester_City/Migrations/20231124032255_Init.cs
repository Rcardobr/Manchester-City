        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LogoEquipo = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    IdFotoEquipo = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    FotoEquipo = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FotoEquipo", x => x.IdFotoEquipo);
                    table.ForeignKey(
                        name: "FK_FotoEquipo_Usuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaMod = table.Column<DateTime>(type: "date", nullable: false),
                    ImagenNoticia = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaMod = table.Column<DateTime>(type: "date", nullable: false),
                    IdUsuario = table.Column<int>(type: "int", nullable: false),
                    DatoImportante = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Partido", x => x.IdPartido);
                    table.ForeignKey(
                        name: "FK_Partido_Equipo",
                        column: x => x.IdEquipoVisitante,
                        principalTable: "Equipo",
                        principalColumn: "IdEquipo");
                    table.ForeignKey(
                        name: "FK_Partido_Equipo1",
                        column: x => x.IdEquipoLocal,
                        principalTable: "Equipo",
                        principalColumn: "IdEquipo");
                    table.ForeignKey(
                        name: "FK_Partido_Usuario1",
                        column: x => x.IdUsuario,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FotoEquipo_IdUsuario",
                table: "FotoEquipo",
                column: "IdUsuario");

            migrationBuilder.CreateIndex(
                name: "IX_Jugador_IdPosicion",
                table: "Jugador",
                column: "IdPosicion");

            migrationBuilder.CreateIndex(
                name: "IX_Jugador_IdUsuario",
                table: "Jugador",
                column: "IdUsuario");
